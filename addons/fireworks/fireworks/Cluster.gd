...
var second_stage_type = load("res://addons/fireworks/fireworks/ClusterSecondStage.tscn")
var explosion_type = load("res://addons/fireworks/fireworks/Explosion.tscn")
